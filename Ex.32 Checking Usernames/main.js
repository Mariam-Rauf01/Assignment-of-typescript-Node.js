...
let currentUsers = ["Hadiqa", "Mariam", "Laraib", "Fatima", "Eshal"];
let newUsers = ["Hadiqa", "Mariam", "Sarah", "Alia", "Mehak"];
// Function to check if a username is a duplicate
function isDuplicateUsername(username, existingUsernames) {
...
function printUsernameAvailability(username, isDuplicate) {
    if (isDuplicate) {
...
function checkUsernameAvailability(newUsers, currentUsers) {
